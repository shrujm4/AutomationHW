...
//Registration successful (Test Pass or Fail)
    ...
    java.lang.String actualMSG = driver.findElement(By.xpath("//div[@class=\"result\"]")).getText();
...
//Object of previous class for the use of registration
        AutomationHW.userShouldBeAbleToLogInSuccessfully ();
...
@Test (priority = 2)
    ...
    driver.findElement(partialLinkText("Jewelry")).click();
       ...
       // Assert.assertTrue(AM2,EM2);
        ...
        String M5 = driver.findElement(By.xpath("//span[@class='item']")).getText();
